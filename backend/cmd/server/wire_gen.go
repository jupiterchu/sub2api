...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, nextJSUsageHook, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, configConfig)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, nextJSUsageHook, concurrencyService, billingCacheService, apiKeyService, configConfig)
