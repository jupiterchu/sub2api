...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, nextJSUsageHook, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, errorPassthroughService, configConfig)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, nextJSUsageHook, concurrencyService, billingCacheService, apiKeyService, errorPassthroughService, configConfig)
