...
type UpdateConfig struct {
	...
	// Repo is the GitHub repository in "owner/repo" format for online updates.
	Repo string `mapstructure:"repo"`
	// GitHubToken is an optional token for accessing private repositories.
...
func setDefaults() {
	...
	viper.SetDefault("update.repo", "jupiterchu/sub2api")
