...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/jupiterchu/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="jupiterchu/sub2api"
...
Documentation=https://github.com/jupiterchu/sub2api
